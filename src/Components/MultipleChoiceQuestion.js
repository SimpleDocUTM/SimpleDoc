...
class MultipleChoiceQuestion extends React.Component{
    ...
    render(){
        ...
        return (
            <div>
                <FormLabel component="legend" color="primary">{question}</FormLabel>
                    <RadioGroup aria-label={question} value={parseInt(this.state.selected)} onChange={this.onOptionChange}>
